...
export type paths = {
  ...
  readonly '/payment-agents/{payment_agent_id}/proposals': {
    readonly parameters: {
      readonly query?: never;
      readonly header?: never;
      readonly path?: never;
  ...
  readonly '/mandates': {
     ...
     * @description Drafts a PENDING mandate from a direct user interaction - no instruction back-link. The mandate binds the agent's signer; the rule is the one the customer will approve (POST /mandates/{mandate_id}/approve, a recognized signer other than the bound one, §8). Recipient targets may be recipient ids or payee names - names resolve to the customer's existing recipients before anything is stored. Schedule payments under it by mandate_id; they arm the moment it activates.
     */
...
export type components = {
  schemas: {
     ...
     */
    readonly DestinationRequestUnion:
      | components['schemas']['CryptoDestinationRequest']
      | components['schemas']['FiatUSDestinationRequest']
      | components['schemas']['FiatIBANDestinationRequest'];
    /**
     * Destination Request
     ...
     */
    readonly CryptoDestinationRequest: Omit<
      components['schemas']['DestinationRequest'],
      'destination_type'
    > & {
      /**
       * @default crypto
     ...
     */
    readonly FiatUSDestinationRequest: Omit<
      components['schemas']['DestinationRequest'],
      'destination_type'
    > & {
      /**
     ...
     */
    readonly FiatIBANDestinationRequest: Omit<
      components['schemas']['DestinationRequest'],
      'destination_type'
    > & {
      /**
     ...
     */
    readonly DestinationResponseUnion:
      | components['schemas']['CryptoDestinationResponse']
      | components['schemas']['FiatUSDestinationResponse']
      | components['schemas']['FiatIBANDestinationResponse'];
    /**
     ...
     */
    readonly CryptoDestinationResponse: Omit<
     ...
     */
    readonly FiatUSDestinationResponse: Omit<
      components['schemas']['DestinationResponse'],
      'destination_type'
    > & {
      /**
     ...
     */
    readonly FiatIBANDestinationResponse: Omit<
      components['schemas']['DestinationResponse'],
      'destination_type'
    > & {
      /**
    ...
    readonly TransactionResource:
      | components['schemas']['OneOffTransaction']
    ...
    readonly PaginatedTransactionResourceResponse:
      | components['schemas']['PaginatedOneOffTransactionResponse']
      | components['schemas']['PaginatedCustomerTransactionResponse']
      | components['schemas']['PaginatedWalletTransactionResponse'];
     ...
     * @enum {string}
     */
    readonly OneOffTransactionStatus:
      | 'pending'
      | 'processing'
      | 'completed'
      | 'failed'
    ...
    readonly EndorsedRequest: {
      ...
      readonly intent:
        | components['schemas']['SendTransactionIntent']
        | components['schemas']['AttachGroupToWalletIntent']
        | components['schemas']['DetachGroupFromWalletIntent']
        | components['schemas']['AttachPolicyToWalletIntent']
        | components['schemas']['DetachPolicyFromWalletIntent']
        | components['schemas']['AddPolicyRuleIntent']
        | components['schemas']['RemovePolicyRuleIntent']
        | components['schemas']['UpdatePolicyRuleIntent']
        | components['schemas']['DeletePolicyIntent'];
    };
    ...
    readonly BusinessApplicationCreateRequest: {
       ...
       *     ]
       */
      readonly purpose_of_account: readonly (
       ...
       * @enum {string}
       */
      readonly average_monthly_revenue:
        | '0_to_500k'
        | '500k_to_1m'
        | '1m_to_5m'
        | '5m_to_10m'
       ...
       * @enum {string}
       */
      readonly expected_monthly_deposit:
        | '0_to_50k'
        | '50k_to_100k'
        | '100k_to_500k'
        | '500k_to_1m'
       ...
       * @enum {string}
       */
      readonly expected_monthly_transaction_volume:
        | '0_to_10'
        | '10_to_20'
        | '20_to_50'
        | '50_to_100'
       ...
       *     ]
       */
      readonly source_of_funds: readonly (
        | 'ico_token_sale'
        | 'donations'
        | 'loan_funding'
        | 'crowdfunding'
    ...
    readonly IndividualRequest: {
       ...
       *     ]
       */
      readonly source_of_wealth?: readonly (
        | 'investments'
        | 'employment'
        | 'court_settlement'
        | 'lottery_winnings'
     ...
     * @enum {string}
     */
    readonly ApplicationDocumentType:
     ...
     * @enum {string}
     */
    readonly IndividualDocumentType:
      | 'passport'
    ...
    readonly MissingDocument: {
       ...
       *     ]
       */
      readonly accepted_types: readonly (
        | 'articles_of_incorporation'
        | 'certificate_of_good_standing'
        | 'corporate_registry_extract'
        | 'shareholder_registry'
    ...
    readonly CreateMandateRequest: {
      /** @description The mandate binds this agent's signer. */
      readonly payment_agent_id: string;
      readonly rule: components['schemas']['MandateRule'];
      /** Format: int64 */
      readonly valid_from?: number;
  ...
  parameters: {
     ...
     *     Effective only on `https://api.platform.sandbox.dakota.xyz`. Ignored in production.
     */
    readonly SandboxErrorStepHeader:
     ...
     *     Effective only on `https://api.platform.sandbox.dakota.xyz`. Ignored in production.
     */
    readonly SandboxScenarioHeader:
      | 'happy_path'
      | 'delayed_settlement'
      | 'insufficient_funds'
      | 'compliance_block'
...
export interface operations {
  ...
  readonly createPaymentAgentProposals: {
    readonly parameters: {
      readonly query?: never;
      readonly header?: never;
      readonly path: {
    ...
    readonly requestBody: {
      readonly content: {
         ...
         *     }
         */
        readonly 'application/json': components['schemas']['CreateProposalsRequest'];
      };
    };
    readonly responses: {
      ...
      readonly 200: {
        ...
        content: {
           ...
           *     }
           */
          readonly 'application/json': components['schemas']['AgenticProposalsResult'];
        };
      };
      /** @description Invalid request, or the freeform conversation layer is not configured */
      readonly 400: {
        headers: {
          readonly [name: string]: unknown;
        };
      ...
      /** @description The per-customer proposal-drafting rate limit was exceeded (an hourly burst window and a daily window). Back off and retry later. */
      readonly 429: {
        headers: {
          readonly [name: string]: unknown;
        };
  ...
  readonly cancelScheduledPayment: {
    readonly parameters: {
      ...
      readonly header?: never;
      readonly path: {
        readonly scheduled_payment_id: string;
      };
      readonly cookie?: never;
    };
    readonly requestBody?: never;
    readonly responses: {
      /** @description The cancelled scheduled payment. */
      readonly 200: {
        headers: {
          readonly [name: string]: unknown;
        };
        content: {
           ...
           *     }
           */
          readonly 'application/json': components['schemas']['ScheduledPaymentResponse'];
        };
      };
      /** @description Unknown payment or not cancellable (executed, failed, or already cancelled). */
      readonly 400: {
        headers: {
          readonly [name: string]: unknown;
        };
